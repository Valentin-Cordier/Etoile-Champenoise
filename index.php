    ...
    <div class="row pb-5 pt-5 d-flex justify-content-around text-light" style="background: rgb(31, 39, 92)">
        <div class="ite text-center mt-3 col-lg-3 col-sm-12">
            <div class="supit mb-4 mx-auto">
                ...
                <i class="far fa-check-circle fa-3x mt-5"></i>
            </div>
            <h4 class="mb-3" style="font-size:2em;color:rgb(196, 155, 43)">Simplicité</h4>

            <p class="col-lg-12 col-sm-6 mx-auto">Sûreté et traçabilité de vos expéditions grâce à un
                étiquetage code-barres Norme GTF Code INOVERT</p>

        </div>
        <div class="ite text-center mt-3 col-lg-3 col-sm-12">
            <div class="supit mb-4 mx-auto">
                <i class="fas fa-award fa-3x mt-5"></i>
            </div>
        ...
        <div class="ite text-center mt-3 col-lg-3 col-sm-12">
            <div class="supit mb-4 mx-auto">
                <i class="fas fa-shipping-fast fa-3x mt-5 "></i>
            </div>
            <h4 class="mb-3" style="font-size:2em;color:rgb(196, 155, 43)">Rapidité</h4>
